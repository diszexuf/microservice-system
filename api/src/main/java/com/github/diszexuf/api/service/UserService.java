...
import com.github.diszexuf.api.mapper.TokenResponseMapper;
...
import com.github.diszexuf.api.client.KeycloakClient;
        ...
        return personService.register(request)
                .flatMap(personId ->
                        keycloakClient.adminLogin()
                                .flatMap(adminToken -> {
                                    var kcUser = new com.github.diszexuf.api.dto.KeycloakUserRepresentation(
                                            null,
                                            request.getEmail(),
                                            request.getEmail(),
                                            true,
                                    ...
                                    return keycloakClient.registerUser(adminToken, kcUser)
                                            .flatMap(kcUserId -> {
                                                var cred = new com.github.diszexuf.api.dto.KeycloakCredentialsRepresentation(
                                                        "password",
                                                        request.getPassword(),
                                                        false
                                                );
                                            ...
                                            .flatMap(r ->
                                                    keycloakClient.login(
                                                            new com.github.diszexuf.keycloak.dto.UserLoginRequest(
                                                                    request.getEmail(),
                                                                    request.getPassword()
                                                            )
                                                    )
